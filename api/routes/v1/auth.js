...
Router.post('/sociallogin', checkSocialLoginParams, Controller.socialLogin, Controller.sendJson);
...
Router.get('/dev/deluser', Controller.delUser, Controller.sendJson);
