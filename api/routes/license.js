...
Router.get('/ppp/v1.0/:address', licenseModule.getPppByAddressV1.bind(licenseModule));
...
Router.post('/release/v1.0', licenseModule.releaseLicenseV1.bind(licenseModule));
