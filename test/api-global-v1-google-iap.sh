curl --location --request POST "https://t2.musicoin.org/api/v1/google/iap?email=$1&accessToken=$2" \
  ...
  --data "{
    \"receipt\":'{\"orderId\":\"GPA.3374-6177-5888-15708\",\"packageName\":\"org.musicoin.musicoin\",\"productId\":\"coin_100\",\"purchaseTime\":1554    389759286,\"purchaseState\":0,\"purchaseToken\":\"abdbmelemojpofjogibfhnhb.AO-J1Oz4oed9R4d5twz2Bc1iza-xypd0c8wSBmHuZDpq95o-NQNSUcOaruJ24SsBDN4MpfC22kDe    eKrjLgi738r84-pYpFxeYMEM2eZOST0junA1EYQ_Fzk\"}',
